...
export default function BMWX7Page() {
  ...
  useEffect(() => {
    ...
    const fetchProgress = async () => {
      try {
        const res = await fetch(`/api/sorteos/bmw-x7/progress`)
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 grid gap-8 lg:grid-cols-2">
          <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
            <Image
              src={BMWX7Images[currentImageIndex]}
        ...
        {/* Purchase Section with sorteo-specific pricing */}
        {!sorteo.agotado ? (
...
export const metadata = {
  title: 'BMW X7 2024 - Sorteo FortuRD',
  description: 'Participa en el sorteo del BMW X7 2024. SUV de lujo de 7 pasajeros con la mejor tecnología.',
}
