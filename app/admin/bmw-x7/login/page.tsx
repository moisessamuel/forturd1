...
export default function BMWX7AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verify user has access to BMW X7
      if (data.role !== 'sorteo_bmw-x7' && data.role !== 'admin') {
        throw new Error('No tienes acceso a este panel')
      }

      sessionStorage.setItem('bmwx7_admin_session', JSON.stringify(data))
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center">
          <div className="relative mb-4 h-32 w-48">
            <Image
              src="/images/bmw-x7.jpg"
              alt="BMW X7"
              fill
              className="rounded-lg object-cover"
            />
          </div>
          <h1 className="mb-2 text-2xl font-bold text-primary">Panel BMW X7</h1>
